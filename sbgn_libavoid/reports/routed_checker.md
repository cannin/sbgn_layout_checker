...
| Arc-crossing events | 215 | - |
| Arc pairs with crossings | 197 / 30470 | 0.65% |
| Arc-node overlaps | 128 / 53247 | 0.24% |

## Per-file counts

| File | Nodes checked | Arcs checked | Arc pairs | Crossing events | Crossing pairs | Arc-node pairs | Arc-node overlaps |
|---|---:|---:|---:|---:|---:|---:|---:|
| `R-HSA-112310.sbgn` | 157 | 178 | 15753 | 96 | 92 | 27590 | 20 |
| `R-HSA-2559583.sbgn` | 4 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-2978092.sbgn` | 7 | 6 | 15 | 1 | 1 | 30 | 0 |
| `R-HSA-5610787.sbgn` | 110 | 124 | 7626 | 59 | 50 | 13392 | 62 |
| `R-HSA-5627083.sbgn` | 8 | 9 | 36 | 1 | 1 | 54 | 0 |
| `R-HSA-5659735.sbgn` | 4 | 3 | 3 | 0 | 0 | 6 | 0 |
| `R-HSA-70635.sbgn` | 73 | 81 | 3240 | 21 | 20 | 5751 | 20 |
| `R-HSA-8963693.sbgn` | 53 | 61 | 1830 | 17 | 17 | 3111 | 7 |
| `R-HSA-9823587.sbgn` | 5 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-9925563.sbgn` | 8 | 8 | 28 | 0 | 0 | 48 | 0 |
| `R-HSA-9932298.sbgn` | 31 | 34 | 561 | 4 | 4 | 986 | 2 |
| `R-HSA-9942503.sbgn` | 45 | 53 | 1378 | 16 | 12 | 2279 | 17 |
...
Run `uv run python analyze_sbgn_layout.py sbgn_libavoid/outputs/routed --output sbgn_libavoid/reports/routed_checker.md` from the project root.
