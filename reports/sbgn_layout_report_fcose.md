...
| Arc-crossing events | 425 | - |
| Arc pairs with crossings | 425 / 30470 | 1.39% |
| Arc-node overlaps | 164 / 53247 | 0.31% |

## Per-file counts

| File | Nodes checked | Arcs checked | Arc pairs | Crossing events | Crossing pairs | Arc-node pairs | Arc-node overlaps |
|---|---:|---:|---:|---:|---:|---:|---:|
| `R-HSA-112310.sbgn` | 157 | 178 | 15753 | 235 | 235 | 27590 | 69 |
| `R-HSA-2559583.sbgn` | 4 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-2978092.sbgn` | 7 | 6 | 15 | 4 | 4 | 30 | 0 |
| `R-HSA-5610787.sbgn` | 110 | 124 | 7626 | 59 | 59 | 13392 | 38 |
| `R-HSA-5627083.sbgn` | 8 | 9 | 36 | 0 | 0 | 54 | 0 |
| `R-HSA-5659735.sbgn` | 4 | 3 | 3 | 0 | 0 | 6 | 0 |
| `R-HSA-70635.sbgn` | 73 | 81 | 3240 | 52 | 52 | 5751 | 19 |
| `R-HSA-8963693.sbgn` | 53 | 61 | 1830 | 42 | 42 | 3111 | 17 |
| `R-HSA-9823587.sbgn` | 5 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-9925563.sbgn` | 8 | 8 | 28 | 3 | 3 | 48 | 0 |
| `R-HSA-9932298.sbgn` | 31 | 34 | 561 | 7 | 7 | 986 | 2 |
| `R-HSA-9942503.sbgn` | 45 | 53 | 1378 | 23 | 23 | 2279 | 19 |
...
Run `uv run python analyze_sbgn_layout.py examples/sbgn_examples_fcose -o reports/sbgn_layout_report_fcose.md` from the project root.
