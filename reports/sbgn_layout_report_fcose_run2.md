...
| Arc-crossing events | 492 | - |
| Arc pairs with crossings | 492 / 30470 | 1.61% |
| Arc-node overlaps | 153 / 53247 | 0.29% |

## Per-file counts

| File | Nodes checked | Arcs checked | Arc pairs | Crossing events | Crossing pairs | Arc-node pairs | Arc-node overlaps |
|---|---:|---:|---:|---:|---:|---:|---:|
| `R-HSA-112310.sbgn` | 157 | 178 | 15753 | 302 | 302 | 27590 | 68 |
| `R-HSA-2559583.sbgn` | 4 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-2978092.sbgn` | 7 | 6 | 15 | 2 | 2 | 30 | 0 |
| `R-HSA-5610787.sbgn` | 110 | 124 | 7626 | 73 | 73 | 13392 | 32 |
| `R-HSA-5627083.sbgn` | 8 | 9 | 36 | 0 | 0 | 54 | 0 |
| `R-HSA-5659735.sbgn` | 4 | 3 | 3 | 0 | 0 | 6 | 0 |
| `R-HSA-70635.sbgn` | 73 | 81 | 3240 | 43 | 43 | 5751 | 18 |
| `R-HSA-8963693.sbgn` | 53 | 61 | 1830 | 40 | 40 | 3111 | 16 |
| `R-HSA-9823587.sbgn` | 5 | 0 | 0 | 0 | 0 | 0 | 0 |
| `R-HSA-9925563.sbgn` | 8 | 8 | 28 | 4 | 4 | 48 | 0 |
| `R-HSA-9932298.sbgn` | 31 | 34 | 561 | 8 | 8 | 986 | 4 |
| `R-HSA-9942503.sbgn` | 45 | 53 | 1378 | 20 | 20 | 2279 | 15 |
...
Run `uv run python analyze_sbgn_layout.py examples/sbgn_examples_fcose_run2 --output reports/sbgn_layout_report_fcose_run2.md` from the project root.
