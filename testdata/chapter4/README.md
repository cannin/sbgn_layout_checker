...
filename/manifest. The 4.2.5 fixture uses an explicit invalid orientation value
to exercise the checker's machine-readable guard. Other qualitative Section 4.4
...
Annotated PNGs for every rule with an implemented finding are generated by
`./scripts/render_rule_examples.py` and documented in
[`docs/rule_examples.md`](../../docs/rule_examples.md).
